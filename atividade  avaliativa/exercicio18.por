programa
{
	funcao real reajuste_Etanol(real &valor1, real reajuste){
		real resultado
		resultado = valor1 + reajuste
		retorne resultado
	}
	funcao real reajuste_Gasolina(real &valor1, real reajuste){
